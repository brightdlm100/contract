...
public class YangoProccessor implements PageProcessor {
  /*  private Site site = Site.me().setRetryTimes(3).setSleepTime(1000).setTimeOut(3000)
    ...
    public void process(Page page) {
       ...
       WebDriver driver = new ChromeDriver();
    	...
    	driver.get("https://sso.yango.com.cn/LoginLight.aspx");
        ...
        driver.findElement(By.id("txtUserName")).sendKeys("denglimeng");
        driver.findElement(By.id("txtPassword")).sendKeys("brightdlm100");
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new YangoProccessor())
