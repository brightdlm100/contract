...
public class UpdateRecord_ContractOverview_GuiYang {
	public Date recDate;
	...
	public UpdateRecord_ContractOverview_GuiYang() {
	...
	public static class UpdateRecord_Contract{
		...
		public UpdateRecord_Contract(贵阳合同 contract2) {
			this.room=contract2.房间;
			this.name=contract2.客户名称;
			this.telephone=contract2.联系电话;
		}
	}
